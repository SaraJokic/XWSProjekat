...
const (
	...
	AvailabilityService_UpdateAvailability_FullMethodName     = "/AvailabilityService/UpdateAvailability"
	AvailabilityService_UpdateAfterReservation_FullMethodName = "/AvailabilityService/UpdateAfterReservation"
	AvailabilityService_Search_FullMethodName                 = "/AvailabilityService/Search"
)
...
type AvailabilityServiceClient interface {
	...
	UpdateAfterReservation(ctx context.Context, in *UpdateAfterReservationRequest, opts ...grpc.CallOption) (*UpdateAfterReservationResponse, error)
	Search(ctx context.Context, in *SearchAvailabilityRequest, opts ...grpc.CallOption) (*SearchAvailabilityResponse, error)
}
...
func (c *availabilityServiceClient) UpdateAvailability(ctx context.Context, in *UpdateAvailabilityRequest, opts ...grpc.CallOption) (*UpdateAvailabilityResponse, error) {
	out := new(UpdateAvailabilityResponse)
	err := c.cc.Invoke(ctx, AvailabilityService_UpdateAvailability_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *availabilityServiceClient) UpdateAfterReservation(ctx context.Context, in *UpdateAfterReservationRequest, opts ...grpc.CallOption) (*UpdateAfterReservationResponse, error) {
	out := new(UpdateAfterReservationResponse)
	err := c.cc.Invoke(ctx, AvailabilityService_UpdateAfterReservation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *availabilityServiceClient) Search(ctx context.Context, in *SearchAvailabilityRequest, opts ...grpc.CallOption) (*SearchAvailabilityResponse, error) {
	out := new(SearchAvailabilityResponse)
	err := c.cc.Invoke(ctx, AvailabilityService_Search_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AvailabilityServiceServer interface {
	...
	UpdateAfterReservation(context.Context, *UpdateAfterReservationRequest) (*UpdateAfterReservationResponse, error)
	Search(context.Context, *SearchAvailabilityRequest) (*SearchAvailabilityResponse, error)
...
func (UnimplementedAvailabilityServiceServer) UpdateAvailability(context.Context, *UpdateAvailabilityRequest) (*UpdateAvailabilityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAvailability not implemented")
}
func (UnimplementedAvailabilityServiceServer) UpdateAfterReservation(context.Context, *UpdateAfterReservationRequest) (*UpdateAfterReservationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAfterReservation not implemented")
}
func (UnimplementedAvailabilityServiceServer) Search(context.Context, *SearchAvailabilityRequest) (*SearchAvailabilityResponse, error) {
...
func _AvailabilityService_UpdateAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateAvailabilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvailabilityServiceServer).UpdateAvailability(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AvailabilityService_UpdateAvailability_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvailabilityServiceServer).UpdateAvailability(ctx, req.(*UpdateAvailabilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AvailabilityService_UpdateAfterReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateAfterReservationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvailabilityServiceServer).UpdateAfterReservation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AvailabilityService_UpdateAfterReservation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvailabilityServiceServer).UpdateAfterReservation(ctx, req.(*UpdateAfterReservationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AvailabilityService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchAvailabilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvailabilityServiceServer).Search(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AvailabilityService_Search_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvailabilityServiceServer).Search(ctx, req.(*SearchAvailabilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AvailabilityService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AvailabilityService_UpdateAvailability_Handler,
		},
		{
			MethodName: "UpdateAfterReservation",
			Handler:    _AvailabilityService_UpdateAfterReservation_Handler,
		},
		{
			MethodName: "Search",
			Handler:    _AvailabilityService_Search_Handler,
		},
	},
