...
const (
	EventStore_CreateEvent_FullMethodName     = "/eventstore.EventStore/CreateEvent"
	EventStore_GetEvents_FullMethodName       = "/eventstore.EventStore/GetEvents"
	EventStore_GetEventsStream_FullMethodName = "/eventstore.EventStore/GetEventsStream"
)
...
func (c *eventStoreClient) CreateEvent(ctx context.Context, in *CreateEventRequest, opts ...grpc.CallOption) (*CreateEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventStore_CreateEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventStoreClient) GetEvents(ctx context.Context, in *GetEventsRequest, opts ...grpc.CallOption) (*GetEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventStore_GetEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventStoreClient) GetEventsStream(ctx context.Context, in *GetEventsRequest, opts ...grpc.CallOption) (EventStore_GetEventsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &EventStore_ServiceDesc.Streams[0], EventStore_GetEventsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _EventStore_CreateEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventStore_CreateEvent_FullMethodName,
	}
